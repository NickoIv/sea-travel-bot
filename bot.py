...
# ─── Когда лучше ехать ──────────────────────────────────────────────────────
# Даты и температуры собраны и перепроверены по нескольким независимым
# travel-источникам 2026 года (climate-справочники, официальные метеослужбы
# по Сингапуру). Это средние по годам цифры, а не прогноз погоды — год на
# год отличается, тайфуны и муссоны могут сдвигаться на пару недель.

SEASON_INFO_DATA = {
    "vn": {
        "best_months": "Идеального месяца для всей страны разом не существует — климат сильно разный по регионам. Февраль-апрель хороши для юга и центра, март-май и сентябрь-ноябрь — для севера.",
        "avoid": "Июнь-август на севере (жара +32...+35°C при высокой влажности) и сентябрь-ноябрь на центральном побережье (пик сезона дождей и тайфунов).",
        "temp_range": "Юг (Хошимин, Фукуок) стабильно +25...+34°C круглый год. Центр (Дананг, Хойан, Нячанг) +24...+33°C. Север (Ханой) резко сезонный: зима +14...+18°C и сыро, лето +28...+35°C.",
        "rainy_season": "Юг: сухо ноябрь-апрель, дожди май-октябрь (короткие ливни ближе к вечеру). Центр: отдельный сезон дождей сентябрь-декабрь/январь с риском тайфунов, особенно октябрь-ноябрь. Север: относительно сухо октябрь-апрель, дождливое лето май-август.",
        "regional_note": "Важно для маршрута по нашим городам: Ханой зимой (декабрь-февраль) реально холодный и пасмурный по вьетнамским меркам — бери тёплую одежду, это не тропики. Дананг, Хойан и Нячанг живут по другому календарю: их сезон дождей — сентябрь-декабрь, тогда возможны тайфуны и подтопления в Хойане. Фукуок на юге в это время как раз в разгаре сухого сезона.",
        "crowds": "Пик цен и турпотока — Тет (вьетнамский Новый год, конец января/февраль, отели дорожают в разы) и рождественские каникулы на курортах юга.",
    },
    "id": {
        "best_months": "Май-сентябрь — сухой сезон, самое надёжное время для Бали и Ломбока. Май-июнь и сентябрь — то же хорошее сухое окно, но заметно спокойнее и дешевле пиковых июля-августа.",
        "avoid": "Январь-февраль — пик сезона дождей, ливни ежедневные и продолжительные.",
        "temp_range": "Круглый год стабильно +26...+33°C днём на побережье — разница между сезонами по температуре небольшая, разница в основном в дождях и влажности.",
        "rainy_season": "Сухой сезон: апрель-октябрь (пик июль-август). Сезон дождей: ноябрь-март, обычно короткими интенсивными ливнями во второй половине дня, а не сплошной моросью весь день.",
        "regional_note": "Убуд расположен на высоте ~600 м и заметно прохладнее и дождливее побережья в любой сезон — вечерами свежо, пригодится лёгкая кофта. Денпасар, Семиньяк, Санур и Ломбок/Гили в сухой сезон суше и жарче Убуда даже в те же месяцы.",
        "crowds": "Июль-август и рождественские каникулы — пик цен и толп, дороги и аэропорт перегружены.",
    },
    "sg": {
        "best_months": "Февраль-апрель — самое сухое и солнечное окно в году, хотя разница с остальными месяцами не драматична.",
        "avoid": "Ноябрь-январь — сезон северо-восточного муссона, самые частые и сильные дожди в году.",
        "temp_range": "Экваториальный климат без выраженных сезонов — круглый год стабильно +24...+32°C и высокая влажность 80-90%.",
        "rainy_season": "Настоящих сухого и дождливого сезонов, как в остальной Юго-Восточной Азии, в Сингапуре нет — дожди возможны в любой месяц. Но ноябрь-январь (северо-восточный муссон) заметно мокрее: до 19-20 дождливых дней в месяц, декабрь — самый дождливый месяц в году. Обычно это яркие короткие ливни во второй половине дня, а не дождь весь день.",
        "regional_note": "Город компактный, климат везде одинаковый — регионального разброса, как во Вьетнаме или Индонезии, здесь нет: главное отличие по сезону, а не по району.",
        "crowds": "Декабрь — не только самый дождливый, но и один из самых дорогих месяцев из-за Рождества/Нового года и школьных каникул — отели заметно дорожают.",
    },
    "eg": {
        "best_months": "Октябрь-апрель — комфортное окно для Каира и Луксора/Асуана. Для пляжей Красного моря (Хургада, Шарм-эль-Шейх) хорошо практически круглый год, включая лето.",
        "avoid": "Июнь-август в Каире и особенно в Луксоре/Асуане — дневная жара обычно за +38...+42°C, иногда выше +45°C, пешие экскурсии по храмам даются тяжело.",
        "temp_range": "Каир: зимой +18...+22°C днём, летом +33...+37°C. Луксор/Асуан летом — одни из самых жарких городов планеты, +40...+45°C в тени. Хургада/Шарм-эль-Шейх мягче за счёт моря: зимой +21...+25°C, летом +32...+36°C, вода +22...+29°C круглый год.",
        "rainy_season": "Дождей в привычном понимании в Египте почти нет в любое время года — страна пустынная. Риск скорее в другом: холодные ветра и редкие песчаные бури (хамсин) весной, март-май.",
        "regional_note": "Ключевая развилка маршрута: Каир и Луксор — это про историю и жару, летом там тяжело физически (полуденное солнце, мало тени у храмов). Хургада и Шарм-эль-Шейх — про Красное море, и там всё иначе: даже в разгар лета жару смягчает морской бриз, а зимой (декабрь-февраль) вода и воздух остаются достаточно тёплыми для купания и дайвинга — жёсткого несезона на побережье практически нет.",
        "crowds": "Декабрь-январь (европейские зимние каникулы) — пик цен и бронирований на побережье. В Рамадан (даты сдвигаются по годам) в Каире и Луксоре часть заведений днём закрыта.",
    },
    "cn": {
        "best_months": "Ноябрь-апрель — высокий сезон и самое комфортное время: сухо, солнечно, без духоты.",
        "avoid": "Август-сентябрь — пик сезона тайфунов, возможны отмены рейсов и штормовые предупреждения на пляжах.",
        "temp_range": "Зимой (декабрь-февраль) +20...+26°C — Санья остаётся тёплой, когда в остальном Китае снег и мороз. Летом (июнь-август) +28...+34°C при высокой влажности, вода круглый год не ниже +22°C.",
        "rainy_season": "Сезон тайфунов — июль-ноябрь, пик август-сентябрь, именно тогда высок риск на несколько дней остаться без пляжа. Зима (декабрь-февраль) практически без дождей и тайфунов.",
        "regional_note": "Санья — тропическая южная оконечность острова и объективно самое тёплое направление во всём Китае: пока на севере страны зима, здесь в разгаре пляжный сезон — отсюда и статус зимнего курорта № 1 у самих китайцев.",
        "crowds": "Китайский Новый год (январь-февраль, даты плавающие) и Golden Week 1-7 октября — пиковые цены и переполненные пляжи/отели, бронировать нужно сильно заранее.",
    },
}

def fmt_season_info(country_code: str) -> str:
    _, name = COUNTRIES.get(country_code, ("", "?"))
    d = SEASON_INFO_DATA.get(country_code)
    if not d:
        return "Информация недоступна"
    return (
        f"🗓 <b>Когда лучше ехать — {name}</b>\n\n"
        f"👍 <b>Лучшее время:</b> {d['best_months']}\n\n"
        f"🚫 <b>Когда лучше не ехать:</b> {d['avoid']}\n\n"
        f"🌡 <b>Температуры:</b> {d['temp_range']}\n\n"
        f"🌧 <b>Дожди/тайфуны:</b> {d['rainy_season']}\n\n"
        f"📍 <b>Важно для наших городов:</b> {d['regional_note']}\n\n"
        f"👥 <b>Пик цен и турпотока:</b> {d['crowds']}\n\n"
        f"<i>Цифры усреднённые за последние годы — год на год не приходится</i>"
    )

# Дневной бюджет поездки — три уровня (эконом/бэкпекер, средний, премиум/люкс)
# в USD на человека в день, без учёта международного перелёта и визы. Суммы
# ориентировочно покрывают: жильё + еда + локальный транспорт + одна платная
# активность/экскурсия в день — это НЕ пакетный all-inclusive тур. Диапазоны
# сведены по нескольким источникам (Budget Your Trip, Numbeo, travel-блоги и
# форумы 2025-2026), а не по одному сайту — но это всё равно грубая прикидка:
# реальная сумма сильно зависит от сезона, конкретного города/курорта внутри
# страны и личного стиля путешествия. Цифры по Египту особенно нестабильны —
# из-за девальвации фунта расчёт в USD/KZT меняется быстрее, чем в среднем.
BUDGET_INFO_DATA = {
    "vn": {
        "economy": {"range": (20, 35), "note": "Хостел/гестхаус, стритфуд и локальные кафе-«кому», автобусы и электробайк напрокат, изредка Grab"},
        "mid":     {"range": (50, 90), "note": "3-4★ отель или уютный бутик, кафе и рестораны для туристов, такси/Grab, один платный тур или экскурсия в день"},
        "premium": {"range": (150, 300), "note": "5★ отель/резорт или вилла с бассейном, рестораны и морепродукты, приватный водитель и трансферы, гид на экскурсиях"},
    },
    "id": {
        "context": "В Убуде и вглубь острова жильё и еда заметно дешевле, чем в туристических зонах юга (Семиньяк, Чангу, Улувату) — при том же уровне комфорта разница может быть 20-30%.",
        "economy": {"range": (25, 40), "note": "Лосмен/гестхаус или хостел, варунги и стритфуд, аренда мотобайка или Grab/Gojek на мотобайке"},
        "mid":     {"range": (70, 150), "note": "3-4★ отель или вилла со своим бассейном, кафе и рестораны, такси/приватный водитель на день, одна платная экскурсия или спа"},
        "premium": {"range": (250, 500), "note": "5★ резорт или приватная вилла у моря, рестораны и бич-клубы, приватные трансферы и водитель весь день, премиальный спа и туры"},
    },
    "sg": {
        "economy": {"range": (60, 90), "note": "Общий номер в хостеле, фудкорты и хокер-центры, MRT/автобус"},
        "mid":     {"range": (130, 220), "note": "3-4★ отель, рестораны среднего уровня, Grab/такси, один платный аттракцион в день (Gardens by the Bay, Universal Studios и т.п.)"},
        "premium": {"range": (350, 600), "note": "5★ отель у Marina Bay или на Orchard Road, рестораны высокой кухни, такси/приватный трансфер, премиальные шоу и экскурсии"},
    },
    "eg": {
        "economy": {"range": (30, 50), "note": "Хостел/бюджетная гостиница, стритфуд и местные кафе (кошари, фул), общественный транспорт и шеринг-такси"},
        "mid":     {"range": (90, 180), "note": "3-4★ отель с завтраком, смесь местной и туристической кухни, такси/Uber/Careem, экскурсия с гидом-египтологом"},
        "premium": {"range": (250, 500), "note": "4-5★ отель или сьют с видом на Нил (либо каюта на круизе), приватный гид и водитель весь день, fine dining"},
    },
    "cn": {
        "context": "Санья — курортный остров: даже бюджетные варианты жилья здесь дороже, чем в среднем по материковому Китаю, так как дешёвых хостелов у моря немного.",
        "economy": {"range": (40, 65), "note": "Гестхаус/бюджетный отель не у первой линии, местные закусочные и рынки еды, автобус или Didi на короткие поездки"},
        "mid":     {"range": (90, 160), "note": "3-4★ отель, рестораны с морепродуктами, Didi по городу, один платный аттракцион (напр. Ялунвань, остров Wuzhizhou)"},
        "premium": {"range": (220, 450), "note": "5★ резорт на первой линии (Sanya Bay/Yalong Bay), рестораны отеля, приватные трансферы, спа и премиальные туры"},
    },
}

def fmt_budget_info(country_code: str) -> str:
    _, name = COUNTRIES.get(country_code, ("", "?"))
    d = BUDGET_INFO_DATA.get(country_code)
    if not d:
        return "Информация недоступна"

    tiers = [
        ("economy", "🎒 Эконом / бэкпекер"),
        ("mid", "🏨 Средний"),
    ...
    for key, label in tiers:
        ...
        if not tier:
            continue
        low, high = tier["range"]
        kzt_low = convert_to_kzt(low, "usd")
        kzt_high = convert_to_kzt(high, "usd")
        kzt_part = f" (≈ {kzt_low:,.0f}-{kzt_high:,.0f} KZT)" if kzt_low and kzt_high else ""
        blocks.append(f"<b>{label}:</b> ${low}-{high}/день{kzt_part}\n{tier['note']}")

    context = d.get("context")
    context_part = f"<i>{context}</i>\n\n" if context else ""

    return (
        f"💰 <b>Бюджет на день — {name}</b>\n\n"
        f"{context_part}"
        + "\n\n".join(blocks)
        + "\n\n<i>Цены очень приблизительные: сильно зависят от сезона, региона/курорта внутри страны "
        "и личного стиля путешествия — это ориентир для планирования, а не точный расчёт. "
        "Не включает международный перелёт, визу и пакетные all-inclusive туры.</i>"
    )

# Базовый разговорник: 12-15 практических фраз на каждый язык — не случайный
# список, а то, что реально нужно туристу (приветствие/прощание, вежливость,
# рынок и торг, туалет, «не понимаю», «говорите по-английски», еда/аллергии,
# счёт в ресторане). Написание на местном языке сверено со стандартными
# туристическими разговорниками (Lonely Planet phrasebooks, Wikitravel/
# Wikivoyage phrasebook-статьи) и словарями — вьетнамские диакритики и
# арабская графика Египта проверялись отдельно вручную. Транскрипция дана
# приблизительно кириллицей «на слух» (не строгая научная транслитерация
# вроде системы Палладия), чтобы турист мог просто прочитать и худо-бедно
# произнести, не зная правил чтения. Для Сингапура — не разговорник (там
# везде понимают английский), а короткая подборка местных словечек Singlish.
PHRASEBOOK_DATA = {
    "vn": [
        ("Здравствуйте", "Xin chào", "синь тяо"),
        ("До свидания", "Tạm biệt", "там бьет"),
        ("Спасибо", "Cảm ơn", "кам эн"),
        ("Пожалуйста / Не за что", "Không có gì", "хонг ко зи"),
        ("Да", "Vâng", "вынг"),
        ("Нет", "Không", "хонг"),
        ("Извините / Простите", "Xin lỗi", "синь лой"),
        ("Сколько это стоит?", "Cái này bao nhiêu tiền?", "кай най бао ниеу тьен"),
        ("Слишком дорого! Дешевле можно?", "Đắt quá! Bớt chút được không?", "дат куа! бот тьют дыок хонг"),
        ("Помогите!", "Cứu tôi với!", "кыу той вой"),
        ("Где туалет?", "Nhà vệ sinh ở đâu?", "ня вэ шинь ы дау"),
        ("Я не понимаю", "Tôi không hiểu", "той хонг хьеу"),
        ("Вы говорите по-английски?", "Bạn có nói tiếng Anh không?", "бан ко ной тьенг ань хонг"),
        ("Не остро, пожалуйста", "Không cay, làm ơn", "хонг кай, лам эн"),
        ("Счёт, пожалуйста", "Tính tiền, làm ơn", "тинь тьен, лам эн"),
    ],
    "id": [
        ("Здравствуйте", "Halo", "хало"),
        ("До свидания", "Sampai jumpa", "сампай джумпа"),
        ("Спасибо", "Terima kasih", "терима касих"),
        ("Пожалуйста / Не за что", "Sama-sama", "сама-сама"),
        ("Да", "Ya", "я"),
        ("Нет", "Tidak", "тидак"),
        ("Извините / Простите", "Maaf", "мааф"),
        ("Сколько это стоит?", "Berapa harganya?", "берапа харганья"),
        ("Слишком дорого! Дешевле можно?", "Terlalu mahal, bisa kurang?", "терлалу махал, биса куранг"),
        ("Помогите!", "Tolong!", "толонг"),
        ("Где туалет?", "Di mana toilet?", "ди мана тойлет"),
        ("Я не понимаю", "Saya tidak mengerti", "сая тидак менгерти"),
        ("Вы говорите по-английски?", "Bisa bicara bahasa Inggris?", "биса бичара бахаса инггрис"),
        ("Вкусно!", "Enak!", "энак"),
        ("Счёт, пожалуйста", "Minta bill, ya", "минта бил, я"),
    ],
    "sg": [
        ("Поесть / еда", "makan", "мака́н"),
        ("Потрясающе, кайф", "shiok", "шиок"),
        ("Без проблем, идёт", "can lah", "кэн ла"),
        ("Панический страх упустить выгоду (шутят про местный менталитет)", "kiasu", "кьясу́"),
        ("«Застолбить» столик в фудкорте пачкой салфеток", "chope", "чоуп"),
        ("Неловко, стыдно", "paiseh", "пайсе́"),
        ("Ого! Вот это да!", "wah!", "ва!"),
        ("Шутливое прозвище туриста-европейца", "ang moh", "анг мо"),
    ],
    "eg": [
        ("Здравствуйте", "أهلاً", "ахлан"),
        ("До свидания", "مع السلامة", "маа саляма"),
        ("Спасибо", "شكراً", "шукран"),
        ("Пожалуйста / Не за что", "عفواً", "афван"),
        ("Да", "أيوه", "айва"),
        ("Нет", "لا", "ля"),
        ("Извините / Простите", "آسف", "асиф"),
        ("Сколько это стоит?", "بكام ده؟", "бикам да?"),
        ("Слишком дорого! Дешевле можно?", "غالي أوي! ممكن أرخص؟", "гали ави! мумкин архас?"),
        ("Помогите!", "النجدة!", "ан-нагда!"),
        ("Где туалет?", "فين الحمام؟", "фейн эль-хаммам?"),
        ("Я не понимаю", "أنا مش فاهم", "ана миш фахем"),
        ("Вы говорите по-английски?", "بتتكلم إنجليزي؟", "бититкаллим инглизи?"),
        ("Вкусно!", "لذيذ", "лязиз"),
        ("Счёт, пожалуйста", "الحساب من فضلك", "эль-хисаб мин фадлак"),
    ],
    "cn": [
        ("Здравствуйте", "你好", "нихао"),
        ("До свидания", "再见", "цзайцзянь"),
        ("Спасибо", "谢谢", "сесе"),
        ("Пожалуйста / Не за что", "不客气", "букэци"),
        ("Да, верно", "对", "дуй"),
        ("Нет", "不", "бу"),
        ("Извините / Простите", "对不起", "дуйбуци"),
        ("Сколько это стоит?", "多少钱？", "дошао цянь?"),
        ("Слишком дорого! Дешевле можно?", "太贵了！能便宜点吗？", "тай гуй лэ! нэн пяньи дянь ма?"),
        ("Помогите!", "救命！", "цзюмин!"),
        ("Где туалет?", "厕所在哪里？", "цэсо цзай нали?"),
        ("Я не понимаю", "我不明白", "во бу минбай"),
        ("Вы говорите по-английски?", "你会说英语吗？", "ни хуэй шо инъюй ма?"),
        ("Вкусно!", "好吃", "хаочи"),
        ("Счёт, пожалуйста", "买单", "майдань"),
    ],
}

def fmt_phrasebook(country_code: str) -> str:
    flag, name = COUNTRIES.get(country_code, ("", "?"))
    entries = PHRASEBOOK_DATA.get(country_code)
    if not entries:
        return "Информация недоступна"
    lines = "\n".join(
        f"{flag} <b>{ru}</b> — {local} <i>({translit})</i>"
        for ru, local, translit in entries
    )
    if country_code == "sg":
        return (
            f"🗣️ <b>Полезные словечки — {name}</b>\n\n"
            f"{lines}\n\n"
            f"<i>Английский в Сингапуре понимают везде — это официальный язык, полноценный разговорник не нужен, но эти словечки сделают тебя своим</i>"
        )
    return (
        f"🗣️ <b>Базовый разговорник — {name}</b>\n\n"
        f"{lines}\n\n"
        f"<i>Транскрипция приблизительная — просто читай как написано по-русски</i>"
    )
...
# в готовый план по дням. Ключи совпадают с ключами CURATED (см. _build_curated_index).

ITINERARY_DATA: dict[tuple[str, str], dict] = {
    ("vn", "hanoi"): {
        "days": [
            {"day": 1, "theme": "Исторический и политический центр", "stops": [
                "09:00 — Ho Chi Minh Mausoleum & Ba Dinh Square — комплекс открыт только по утрам, приходите пораньше",
                "10:30 — Temple of Literature — тихие дворики первого университета Вьетнама",
                "12:30 — Banh Mi 25 — обеденный банчик в Старом квартале",
                "18:00 — Hoan Kiem Lake — вечерняя прогулка вокруг озера",
                "19:30 — Thang Long Water Puppet Theatre — вечернее представление водных марионеток",
            ]},
            {"day": 2, "theme": "Старый квартал", "stops": [
                "09:30 — Hanoi Old Quarter — прогулка по 36 старинным улицам",
                "11:00 — Giang Cafe — легендарный яичный кофе (cà phê trứng)",
                "15:00 — Hanoi Train Street — сфотографировать поезд в полуметре от кафе",
                "19:00 — Cha Ca La Vong — ужин с жареной рыбой по рецепту 1871 года",
            ]},
            {"day": 3, "theme": "Западное озеро и прощальный вечер", "stops": [
                "09:00 — West Lake (Ho Tay) — утренняя велопрогулка вдоль набережной",
                "11:30 — Cong Caphe — кокосовый кофе-смузи в стиле ретро",
                "13:00 — Bun Cha Huong Lien — тот самый бун ча, что ели Обама с Бурденом",
                "19:00 — Blue Butterfly — прощальный ужин в отреставрированном французском доме",
            ]},
        ],
        "stay_area": "Old Quarter — рядом со всеми точками маршрута",
    },
    ("vn", "da_nang"): {
        "days": [
            {"day": 1, "theme": "Город и мосты", "stops": [
                "09:00 — Da Nang Cathedral (Pink Church) — розовый неоготический собор в центре",
                "10:00 — Cong Caphe — кофе-пауза в стиле ретро",
                "13:00 — Madame Lan — большой выбор вьетнамской кухни на набережной Хан",
                "19:00 — Dragon Bridge — по выходным вечером мост извергает огонь и воду",
            ]},
            {"day": 2, "theme": "Полуостров Шон Ча и пляж", "stops": [
                "08:30 — Son Tra Peninsula (Monkey Mountain) — серпантин и дикие обезьяны лангуры",
                "10:00 — Linh Ung Pagoda — статуя Леди Будды высотой 67 метров",
                "13:00 — My Khe Beach — купание на одном из красивейших пляжей Вьетнама",
                "19:00 — Be Ni 2 — морепродукты, отмеченные Michelin Bib Gourmand",
            ]},
            {"day": 3, "theme": "Горы Ба На", "stops": [
                "08:00 — Ba Na Hills & Golden Bridge — канатная дорога, французская деревня, Золотой мост",
                "15:00 — Marble Mountains (Ngu Hanh Son) — пещеры-гроты по дороге назад",
                "19:00 — Paradise Beach Da Nang — закат в баре-хижине на песке Ми Кхе",
            ]},
        ],
        "stay_area": "My Khe Beach — большинство отелей и лучший пляж рядом",
    },
    ("vn", "hoi_an"): {
        "days": [
            {"day": 1, "theme": "Старый город", "stops": [
                "09:00 — Hoi An Ancient Town — прогулка по объекту Всемирного наследия ЮНЕСКО",
                "09:45 — Japanese Covered Bridge — символ Хойана XVII века",
                "10:15 — Cantonese Assembly Hall — резьба и драконы китайских переселенцев",
                "12:30 — Banh Mi Phuong — культовый банчик, который похвалил Энтони Бурден",
                "18:30 — Thu Bon River Sunset & Lantern Boat Cruise — фонарики на воде на закате",
            ]},
            {"day": 2, "theme": "An Bang Beach", "stops": [
                "08:30 — Reaching Out Teahouse — тихая чайная перед пляжным днём",
                "09:30 — An Bang Beach — пляжный день в 15 минутах от центра",
                "13:00 — An Bang Beach Village Restaurant — жареные креветки прямо на песке",
                "16:00 — Ken's — панкейки и кофе на закате",
                "18:00 — FeFe Roastery — кофе с видом на пагоду Ба Му и фонарики над каналом",
            ]},
            {"day": 3, "theme": "Выезд за пределы города (один из двух вариантов)", "stops": [
                "Вариант А — My Son Sanctuary: полдня среди руин храмов Чампы в джунглях",
                "Вариант Б — Cham Islands (Cu Lao Cham): полный день снорклинга в биосферном заповеднике ЮНЕСКО",
                "19:00 — Morning Glory Restaurant — прощальный ужин от известного хойанского шефа",
            ]},
        ],
        "stay_area": "Near Ancient Town — 10-15 минут пешком до точек Дня 1",
    },
    ("vn", "nha_trang"): {
        "days": [
            {"day": 1, "theme": "Город и храмы", "stops": [
                "08:30 — Po Nagar Cham Towers — храмовый комплекс цивилизации Чампа на холме",
                "10:00 — Nha Trang Cathedral — готический собор на холме",
                "10:45 — Long Son Pagoda — 24-метровая статуя сидящего Будды",
                "13:00 — La Fenêtre Soleil — обед во французской колониальной вилле",
                "18:00 — Tran Phu Beach — вечерняя прогулка по набережной",
            ]},
            {"day": 2, "theme": "Острова и снорклинг", "stops": [
                "09:00 — Hon Mun Island — лодочный тур на снорклинг у коралловых рифов",
                "14:00 — Hon Chong Promontory — «отпечаток ладони великана» и виды на бухту",
                "16:00 — Cookbook Cafe — кофе и десерт с видом на океан",
                "19:00 — Sailing Club Nha Trang — коктейли прямо на песке",
            ]},
            {"day": 3, "theme": "VinWonders и прощание", "stops": [
                "09:00 — VinWonders Nha Trang (Hon Tre Island) — аквапарк, океанариум и аттракционы на весь день",
                "19:00 — Louisiane Brewhouse — крафтовое пиво и морепродукты на берегу",
                "20:30 — Dining by the Rocks — особый прощальный ужин в скалах (по желанию, Six Senses)",
            ]},
        ],
        "stay_area": "Tran Phu Beach — центральная набережная рядом с ресторанами и пляжем",
    },
    ("vn", "phu_quoc"): {
        "days": [
            {"day": 1, "theme": "Южный остров и Хон Тхом", "stops": [
                "08:30 — Hon Thom Cable Car & Sun World — самая длинная канатная дорога над морем",
                "15:00 — Sao Beach (Bai Sao) — белоснежный пляж на юго-востоке острова",
                "18:30 — Aroi Dessert Cafe — десерт на закате с видом на океан",
            ]},
            {"day": 2, "theme": "Дикая природа и рыбацкая деревня", "stops": [
                "09:00 — Vinpearl Safari Phu Quoc — жирафы, львы и сотни видов животных",
                "13:00 — Ham Ninh Fishing Village — обед из свежих морепродуктов на пирсе",
                "15:30 — Phu Quoc Prison Museum — история узников времён войны",
                "18:30 — Sunset Sanato Beach Club — закат над Сиамским заливом",
            ]},
            {"day": 3, "theme": "Город и водопад", "stops": [
                "08:30 — Dinh Cau Rock & Temple — храм на скале у входа в гавань",
                "10:00 — Suoi Tranh Waterfall — купание в водопаде в национальном парке",
                "13:00 — Hana Coffee & Restaurant — кокосовый кофе на канале Grand World",
                "19:00 — Chuon Chuon Bistro & Skybar — коктейли и панорамные окна на прощание",
            ]},
        ],
        "stay_area": "Long Beach (Bai Truong) — рядом с ночным рынком и большинством отелей",
    },
    ("id", "denpasar"): {
        "days": [
            {"day": 1, "theme": "Кута и Семиньяк", "stops": [
                "08:00 — Revolver Espresso — завтрак в культовой кофейне Семиньяка",
                "10:00 — Waterbom Bali — аквапарк на полдня",
                "14:30 — Kuta Beach — сёрферский пляж и набережная",
                "17:30 — Seminyak Beach — закат с коктейлем",
                "19:30 — Motel Mexicola — ужин в стиле мексиканской вечеринки",
            ]},
            {"day": 2, "theme": "Скалы Букита", "stops": [
                "10:00 — Garuda Wisnu Kencana (GWK) Cultural Park — статуя Вишну верхом на Гаруде",
                "13:00 — SIKI — обед в стиле японского фьюжн",
                "17:00 — Uluwatu Temple — храм на скале и танец Кечак на закате",
                "19:30 — Menega Cafe — морепродукты на гриле на пляже Джимбаран",
            ]},
            {"day": 3, "theme": "Нуса-Дуа и запад острова", "stops": [
                "09:30 — Water Blow, Nusa Dua — природный гейзер в скалистом берегу",
                "13:00 — BATIK — обед вьетнамской, тайской и индонезийской кухни",
                "16:00 — Kynd — кофе-пауза в веганском кафе",
                "18:30 — Tanah Lot Temple — храм на скале посреди океана на закате",
            ]},
        ],
        "stay_area": "Seminyak Beach — рестораны, бары и пляж в шаговой доступности",
    },
    ("id", "ubud"): {
        "days": [
            {"day": 1, "theme": "Центр Убуда", "stops": [
                "06:30 — Campuhan Ridge Walk — рассветная прогулка по гребню холма",
                "08:00 — Rüsters — завтрак и кофе собственной обжарки",
                "10:00 — Ubud Palace (Puri Saren Agung) и Ubud Art Market — дворец и рынок ремёсел рядом друг с другом",
                "13:00 — Clear Cafe — обед в веганском кафе с деревянным интерьером",
                "15:30 — Sacred Monkey Forest Sanctuary — храмы и балийские макаки",
            ]},
            {"day": 2, "theme": "Храмы и рисовые террасы", "stops": [
                "09:00 — Tirta Empul Temple — ритуальное очищение в священном источнике",
                "11:30 — Tegalalang Rice Terrace — знаменитые ступенчатые террасы",
                "14:00 — Bali Swing — гигантские качели над джунглями",
                "19:00 — Bebek Bengil (Dirty Duck Diner) — хрустящая утка среди рисовых полей",
            ]},
            {"day": 3, "theme": "Восток и гастрономия", "stops": [
                "09:00 — Goa Gajah (Elephant Cave) — пещерный храм XI века",
                "13:00 — Alchemy — обед в крупном веганском кафе",
                "19:00 — Naughty Nuri's Warung — рёбрышки на гриле и крепкие мартини",
                "20:00 — Locavore — вариант для особого прощального ужина (high-end кухня)",
            ]},
        ],
        "stay_area": "Central Ubud — рядом с дворцом, рынком и большинством кафе",
    },
    ("id", "lombok"): {
        "days": [
            {"day": 1, "theme": "Кута-Мандалика и юг", "stops": [
                "09:00 — Kuta Beach Lombok (Mandalika) — пляж и сёрферский район Мандалика",
                "12:00 — Sade Traditional Sasak Village — традиционная деревня народа сасак",
                "18:00 — Ashtari — ужин на вершине холма с видом на бухту Кута",
            ]},
            {"day": 2, "theme": "Сенгиги и водопады", "stops": [
                "08:00 — Sendang Gile & Tiu Kelep Waterfall — треккинг и купание у подножия Ринджани",
                "13:00 — Mayura Water Palace — королевский водный дворец XVIII века",
                "15:00 — Kenza Cafe & Restaurant — обед у моря в Сенгиги",
                "18:30 — Basilico Restaurant — пицца на дровах и закат над проливом",
            ]},
            {"day": 3, "theme": "Острова Гили", "stops": [
                "08:00 — Gili Trawangan — лодочный день: снорклинг и пляжи без машин и мотоциклов",
                "13:00 — El Bazar Cafe & Restaurant — обед по возвращении в Сенгиги",
                "18:30 — Cafe Alberto — итальянская кухня и живая музыка на закате",
                "Бонус (если есть 4-й день) — Gili Air и Pink Beach (Pantai Tangsi) как тихие альтернативы Гили Траванган; Mount Rinjani требует отдельного 2-3-дневного треккинга",
            ]},
        ],
        "stay_area": "Senggigi Beach — центральный пляжный район с ресторанами рядом",
    },
    ("sg", "singapore"): {
        "days": [
            {"day": 1, "theme": "Marina Bay", "stops": [
                "08:00 — Ya Kun Kaya Toast — традиционный сингапурский завтрак",
                "09:30 — Merlion Park — вид на залив и небоскрёбы",
                "11:00 — Marina Bay Sands SkyPark Observation Deck — панорама на весь город",
                "15:00 — Gardens by the Bay — Супердеревья, Cloud Forest и Flower Dome",
                "19:00 — Lau Pa Sat — ужин на историческом фуд-маркете",
            ]},
            {"day": 2, "theme": "Чайнатаун и Литл-Индия", "stops": [
                "09:00 — Chinatown Singapore — храмы и лавки исторического квартала",
                "12:00 — Tian Tian Hainanese Chicken Rice — курица с рисом на фудкорте Maxwell",
                "14:30 — Little India — специи и индуистские храмы",
                "19:00 — Jumbo Seafood — фирменный чили-краб",
            ]},
            {"day": 3, "theme": "Остров Сентоза", "stops": [
                "09:00 — PS.Cafe — бранч перед поездкой на остров",
                "11:00 — Universal Studios Singapore — тематический парк на весь день (альтернатива: Sentosa Island (Siloso Beach) для пляжного отдыха)",
                "19:30 — Night Safari — первый в мире ночной зоопарк",
                "Опция — Odette — особый прощальный ужин (3 звезды Мишлен)",
            ]},
        ],
        "stay_area": "Marina Bay — рядом с главными достопримечательностями и метро",
    },
    ("eg", "cairo"): {
        "days": [
            {"day": 1, "theme": "Плато Гизы", "stops": [
                "07:00 — Pyramids of Giza & Great Sphinx — приезжать пораньше, пока меньше туристов и жары",
                "11:00 — Grand Egyptian Museum (GEM) — крупнейший археологический музей мира у подножия пирамид",
                "14:00 — Zooba — обед современной уличной египетской еды",
                "19:00 — Sequoia — ужин на террасе над Нилом на острове Замалек",
            ]},
            {"day": 2, "theme": "Исламский и коптский Каир", "stops": [
                "09:00 — Citadel of Saladin (Mosque of Muhammad Ali) — крепость на холме с панорамой на город",
                "10:30 — Al-Azhar Mosque — одна из старейших действующих мечетей мира",
                "11:15 — Khan el-Khalili Bazaar — восточный базар XIV века",
                "12:00 — El-Fishawy — кофе и мята в старейшей кофейне Каира (с 1797 года)",
                "15:00 — Coptic Cairo (Hanging Church) — старейший христианский квартал Каира",
            ]},
            {"day": 3, "theme": "Центр и Нил", "stops": [
                "09:30 — Egyptian Museum, Tahrir Square — зал царских мумий и артефакты фараонов",
                "13:00 — Café Riche — обед в легендарном кафе революционеров и писателей",
                "19:00 — Abou El Sid — традиционный египетский ужин в атмосфере старого дома",
                "20:30 — Nile Felucca Ride — закатная прогулка на парусной лодке по Нилу",
            ]},
        ],
        "stay_area": "Zamalek — тихий остров на Ниле, рядом с ресторанами и в 20-30 минутах от Гизы",
    },
    ("eg", "hurghada"): {
        "days": [
            {"day": 1, "theme": "Море и рифы", "stops": [
                "08:00 — Giftun Island — лодочный день, снорклинг у охраняемого морского парка",
                "18:00 — Vibes Restaurant & Cafe — кофе и закат над Красным морем",
                "19:30 — Moby Dick Restaurant — ужин из свежего улова",
            ]},
            {"day": 2, "theme": "Старый город и набережная", "stops": [
                "09:00 — El Dahar (Old Town) — восточный рынок и узкие улочки старого города",
                "12:00 — Nubian Egyptian Restaurant & Café — обед настоящей египетской кухни",
                "14:00 — El Mina Mosque (Hurghada Grand Mosque) — самая большая мечеть Хургады",
                "18:00 — Hurghada Marina Boulevard — вечерняя прогулка вдоль яхт",
                "19:30 — Granada Restaurant & Pub — популярный ужин у местных и туристов",
            ]},
            {"day": 3, "theme": "Дельфины и пустыня", "stops": [
                "08:00 — Dolphin House (Sha'ab El Erg) — снорклинг-тур с шансом встретить диких дельфинов (альтернатива для тех, кто не плавает: Sindbad Submarine)",
                "13:00 — Boska Restaurant & Café — простой домашний обед",
                "17:00 — Desert Safari & Bedouin Dinner — джипы, бедуинская деревня и ужин под звёздами",
                "Опция — Makadi Water World — семейная альтернатива на день без моря (крупнейший аквапарк Египта)",
            ]},
        ],
        "stay_area": "Sahl Hasheesh — спокойный курортный район со своей набережной",
    },
    ("eg", "sharm"): {
        "days": [
            {"day": 1, "theme": "Наама-Бей", "stops": [
                "09:00 — Old Market (Sharm El Maya) — восточный рынок со специями и сувенирами",
                "13:00 — Boharat Restaurant — обед ближневосточной кухни",
                "17:00 — Naama Bay — прогулка по главной набережной Шарма",
                "18:00 — El Kahwa — кофе и кальян на Soho Square",
                "20:00 — Cafe Chino — ужин с левантийской кухней на Soho Square",
            ]},
            {"day": 2, "theme": "Рифы и снорклинг", "stops": [
                "08:00 — Ras Mohammed National Park — лодочный день на лучшие рифы Красного моря (альтернатива: Tiran Island)",
                "17:00 — Ras Um Sid & Lighthouse — снорклинг прямо от берега и вид на маяк",
                "19:30 — Kouroum of the Nile — ужин с бокалом египетского вина на Soho Square",
            ]},
            {"day": 3, "theme": "Тихие бухты и пустыня", "stops": [
                "09:00 — Shark's Bay — спокойный снорклинг без толп",
                "13:00 — Sushi Lounge — обед в японском ресторане на Soho Square",
                "Опция на весь день — Colored Canyon Desert Safari — джип-сафари в пустыню Синая (альтернатива дню у моря)",
                "20:00 — Hard Rock Cafe Sharm El Sheikh — прощальный ужин в Naama Bay",
            ]},
        ],
        "stay_area": "Naama Bay — центр ночной жизни, рестораны в шаговой доступности",
    },
    ("eg", "luxor"): {
        "days": [
            {"day": 1, "theme": "Восточный берег", "stops": [
                "08:00 — Karnak Temple — крупнейший храмовый комплекс Египта",
                "11:00 — Aboudi Coffee Break — кофе-пауза с видом на Луксорский храм",
                "18:00 — Luxor Temple — особенно красив вечером при подсветке",
                "20:00 — Al-Sahaby Lane Restaurant — ужин на террасе с видом на храм и Нил",
            ]},
            {"day": 2, "theme": "Западный берег и некрополь", "stops": [
                "05:30 — Hot Air Balloon Ride over Luxor — рассвет над Долиной царей (по желанию)",
                "08:00 — Valley of the Kings — расписанные гробницы фараонов Нового царства",
                "11:00 — Hatshepsut Temple (Deir el-Bahari) — храм царицы у скал западного берега",
                "12:30 — Colossi of Memnon — две гигантские статуи по дороге назад",
                "13:00 — Nile Valley Restaurant & Cafe — обед с видом на реку",
            ]},
            {"day": 3, "theme": "Долина цариц и Нил", "stops": [
                "09:00 — Valley of the Queens — гробница Нефертари с лучшими росписями Египта",
                "13:00 — El-Kababgy Luxor — обед у Нила",
                "18:30 — Felucca Ride on the Nile — закатная прогулка на парусной лодке",
                "20:00 — 1886 Restaurant (Sofitel Winter Palace) — особый прощальный ужин",
            ]},
        ],
        "stay_area": "East Bank / Nile Corniche — рядом с Луксорским храмом и лучшими ресторанами",
    },
    ("cn", "hainan"): {
        "days": [
            {"day": 1, "theme": "Пляж и бухта Ялун", "stops": [
                "09:00 — Yalong Bay — купание на «лучшем пляже Китая»",
                "13:00 — Maan Coffee — кофе-пауза в Дадунхае",
                "18:00 — Luhuitou Park (Deer Turning Head Park) — панорама на весь город на закате",
                "19:30 — Linjie Seafood Flavor — ужин с острым крабом хэлэ у Sanya First Market",
            ]},
            {"day": 2, "theme": "Культура и рынок", "stops": [
                "09:00 — Nanshan Buddhist Cultural Zone — 108-метровая статуя Гуаньинь в море",
                "14:00 — Tianya Haijiao (Ends of the Earth) — знаменитая смотровая площадка Санья",
                "16:30 — Cozy Coffee — кофе в тропическом саду",
                "18:30 — Sanya First Market — купить морепродукты и тут же приготовить рядом",
                "19:30 — Chunyuan Seafood Snack Booth — уличные морепродукты на гриле",
            ]},
            {"day": 3, "theme": "Остров и джунгли", "stops": [
                "09:00 — Wuzhizhou Island — дайвинг, снорклинг и параплан над водой",
                "19:00 — Lanyue Seafood Restaurant — ужин из свежего улова",
                "Опции на весь день — Yanoda Rainforest Cultural Tourism Zone (тропический лес) или Atlantis Sanya & The Blue Whale Water Park (аквапарк с детьми)",
            ]},
        ],
        "stay_area": "Yalong Bay — лучший пляж района и большинство отелей 5*",
    },
}
...
def fmt_itinerary(country_code: str, city_key: str) -> str:
    ...
    lines = [
        f"{city['icon']} <b>Маршрут на {n} {_ru_days_word(n)} — {html.escape(city['name'])}</b> ({html.escape(country_name)})"
    ]
    for d in days:
        lines.append(f"\n📅 <b>День {d['day']} — {html.escape(d['theme'])}</b>")
        for stop in d["stops"]:
            lines.append(f"• {html.escape(stop)}")

    stay_area = data.get("stay_area")
    if stay_area:
        lines.append(f"\n🏨 <i>Где лучше жить: {html.escape(stay_area)}</i>")
...
def practical_kb():
    return ReplyKeyboardMarkup(
        [["🆘 Экстренная помощь", "🚕 Транспорт"],
         ["💵 Деньги на месте", "🗓 Сезонность"],
         ["🗣️ Разговорник", "💰 Бюджет поездки"],
         ["⬅️ Назад", "🏠 Главное меню"]],
        resize_keyboard=True, is_persistent=True,
    )
...
async def handle_text(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "🗓 Сезонность" and state.get("country"):
        await update.message.reply_text(fmt_season_info(state["country"]), parse_mode="HTML", reply_markup=practical_kb())
        return

    if text == "🗣️ Разговорник" and state.get("country"):
        await update.message.reply_text(fmt_phrasebook(state["country"]), parse_mode="HTML", reply_markup=practical_kb())
        return

    if text == "💰 Бюджет поездки" and state.get("country"):
        await update.message.reply_text(fmt_budget_info(state["country"]), parse_mode="HTML", reply_markup=practical_kb())
        return

    if text == "📅 Маршрут" and state.get("country") and state.get("city"):
        await update.message.reply_text(
